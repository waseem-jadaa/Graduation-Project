...
<header class="dashboard-header">
  ...
  <nav style="width:100%; display:flex; align-items:center; justify-content:space-between; flex-direction: row;">
      ...
      <!-- Center: Search bar -->
      <form class="search-bar" action="jobs.php" method="get" style="margin:0 1.5rem; flex:1; max-width:400px;">
        <input type="text" name="search" placeholder="ابحث عن وظيفة أو مهني..." aria-label="بحث">
